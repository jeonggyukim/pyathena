...
def observables(s, pid, num, overwrite=False):
    ...
    obsprops_3d = tools.calculate_observables(s, core, rprf, core.tidal_radius, 'three_d')
    obsprops_itr = tools.calculate_observables(s, core, rprf, core.tidal_radius, 'iterative')
