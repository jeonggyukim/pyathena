...
def get_cmap_jh_colors():
    """ function to get John Hawley's famous color table. Red-gray-blue. from Athena palette.h"""
    jh_colors=[0.000000e+00 , 0.000000e+00 , 5.000000e-01 ,
    ...
    jh_colors=np.array(jh_colors)
    from matplotlib.colors import ListedColormap,LinearSegmentedColormap
    cmap = ListedColormap(jh_colors.reshape(256,3))
    # color of missing pixels
    cmap.set_bad('gray')
    # color of background, necessary if you want to use
    cmap.set_under('white')
