...
class SB99(object):
    ...
    def plt_lum_cumul(ax, rr, rw, rs, normed=True, plt_sn=False, lw=2):
        ...
        def integrate_L_cum(L, t): return cumulative_trapezoid((L * au.L_sun).cgs.value,
    ...
    def plt_pdot_cumul(ax, rr, rw, rs, normed=False, plt_sn=False, lw=2):
        ...
        def integrate_pdot(pdot, t): return cumulative_trapezoid(
...
def print_tbl_data(rr):
    ...
    tbl_data.append(r'(4) $\langle \sigma_{\rm d,abs} \rangle$ & '
                    + r' & '.join([r'{0:.2f}'.format(rr['Cabs_Lavg'][b][id x] / 1e-21) for b in bands]) + r' & - \\')
    tbl_data.append(r'(5) $\langle \sigma_{\rm d,ext} \rangle$ & '
                    + r' & '.join([r'{0:.2f}'.format(rr['Cext_Lavg'][b][id x] / 1e-21) for b in bands]) + r' & - \\')
    tbl_data.append(r'(6) $\langle \sigma_{\rm d,pr} \rangle$ & '
                    + r' & '.join([r'{0:.2f}'.format(rr['Crpr_Lavg'][b][id x] / 1e-21) for b in bands]) + r' & - \\')
    # Photoionization cross sections
    tbl_data.append(r'(7) $\langle \sigma_{\rm pi,H} \rangle$ & '
                    + r'{0:.1f}'.format(rr['sigma_pi_H_Qavg'][id x] / 1e-18) + r' & - & - & - & - & - \\')
    tbl_data.append(r'(8) $\langle \sigma_{\rm pi,H_2} \rangle$ & '
                    + r'{0:.1f}'.format(rr['sigma_pi_H2_Qavg'][id x] / 1e-18) + r' & - & - & - & - & - \\')
    # Photon energies
    tbl_data.append(r'\tableline')
