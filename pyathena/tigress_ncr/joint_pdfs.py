...
def jointpdf(ds,par,zmin=0,zmax=300,fields='auto',wfields=['nH'],verbose=False):
    ...
    ranges = dict(nH=(-5,3),T=(1,8),pok=(0,8),vz=(-500,500),
                  ...
                  Lambda_cool=(-30,-18),xH2=(-5,0),xHI=(-5,0),xHII=(-5,0),ne=(-5,3))
    dbins = dict(vz=10)
...
def calc_pdfs(ds,xf='T',yf='Lambda_cool',zmin=0,zmax=300,force_override=False,
    ...
    for zmax,pdf_dict in zip([ds.domain['re'][2],zmax],[pdf_tot,pdf_z]):
        ...
        if radiation:
            pdf_dict['PE']=pdfdict['radiation_energy_density_PE']
            pdf_dict['LW']=pdfdict['radiation_energy_density_LW']
            pdf_dict['PH']=pdfdict['radiation_energy_density_PH']
